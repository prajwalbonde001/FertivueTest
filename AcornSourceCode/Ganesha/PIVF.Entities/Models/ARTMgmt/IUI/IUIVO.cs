...
namespace PIVF.Entities.Models.ARTMgmt.IUI
{
    public class IUIVO
    {
        ...
        //
         ...
         public long CheckedByDoctorID { get; set; }
        public bool SampleCollected { get; set; }
        public bool FrozenSampleCollected { get; set; }
        ...
        public double? PostwashTMSC { get; set; }
        public long DonorUnitID { get; set; }
        public string DonorCode { get; set; }
        public string MRNo { get; set; }
        public bool IsDonorAsPartner { get; set; }
        public List<SemenThawing> ListSemenThawing = new List<SemenThawing>();
        public List<SemenThawing> ListFreezThawSamples = new List<SemenThawing>();
        public bool selected { get; set; }
        public string TIMSI { get; set; }
    }
}
