...
namespace PIVF.Web.Api.ARTMgmt.OPU
{
    [Authorize]
    public class OPUAPIController : ApiController
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();
        OPUBAL srv;
        public OPUAPIController(OPUBAL _srv)
        {
            srv = _srv;
        }
        ...
        [HttpPost]
        public IHttpActionResult SaveUpdate(OPUVO objOPU)
        {
            try
            {
                ...
                var Response = srv.SaveOPU(objOPU);
                return Ok(Response);
            }
        ...
        [ResponseType(typeof(TriggrData))]
        [HttpGet]
        public IHttpActionResult GetTriggerData()
        {
            try
            {
                logger.Info("Controller Name:" + this.ControllerContext.RouteData.Values["controller"] + ",Action:" + HttpContext.Current.Request.HttpMethod +
                 ",Method:" + this.ControllerContext.RouteData.Values["action"] + ",User:{0},UnitID:{1}", GenericSP.CurrentUser.LoginName, GenericSP.CurrentUser.UnitID);
                var Response = srv.GetTriggerData();
                return Ok(Response);
            }
            catch (SqlException ex)
            {
        ...
        [HttpGet]
        public IHttpActionResult GetOPUData()
        {
            try
            {
                logger.Info("Controller Name:" + this.ControllerContext.RouteData.Values["controller"] + ",Action:" + HttpContext.Current.Request.HttpMethod +
                 ",Method:" + this.ControllerContext.RouteData.Values["action"] + ",User:{0},UnitID:{1}", GenericSP.CurrentUser.LoginName, GenericSP.CurrentUser.UnitID);
                var Response = srv.GetOPUData();
                return Ok(Response);
            }
            catch (SqlException ex)
            {
        ...
        [HttpGet]
        public IHttpActionResult IsStimulationFinalize()
        {
            try
            {
                logger.Info("Controller Name:" + this.ControllerContext.RouteData.Values["controller"] + ",Action:" + HttpContext.Current.Request.HttpMethod +
                 ",Method:" + this.ControllerContext.RouteData.Values["action"] + ",User:{0},UnitID:{1}", GenericSP.CurrentUser.LoginName, GenericSP.CurrentUser.UnitID);
                var Response = srv.IsStimulationFinalize();
                return Ok(Response);
            }
            catch (SqlException ex)
            {
        ...
        [ResponseType(typeof(bool))]
        [HttpGet]
        public IHttpActionResult IsOPUFinalize()
        {
            try
            {
                logger.Info("Controller Name:" + this.ControllerContext.RouteData.Values["controller"] + ",Action:" + HttpContext.Current.Request.HttpMethod +
                 ",Method:" + this.ControllerContext.RouteData.Values["action"] + ",User:{0},UnitID:{1}", GenericSP.CurrentUser.LoginName, GenericSP.CurrentUser.UnitID);
                var Response = srv.IsOPUFinalize();
                return Ok(Response);
