...
{
    public partial class ARTSummaryWF_FET : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("ARTSummary_FET.rpt"));
                    ...
                    /*  myDoc.SetParameterValue("@Action", "EmbryoTransferDetails", "subrptFETEmbryoTransfer.rpt");
                      myDoc.SetParameterValue("@TherapyID", TherapyID, "subrptFETEmbryoTransfer.rpt");
                      myDoc.SetParameterValue("@TherapyUnitID", TherapyUnitID, "subrptFETEmbryoTransfer.rpt");*/
