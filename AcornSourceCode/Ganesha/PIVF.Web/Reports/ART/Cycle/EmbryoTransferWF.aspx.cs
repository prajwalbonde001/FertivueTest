...
{
    public partial class EmbryoTransferWF : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("EmbryoTransferDetailReport.rpt"));
                    //  long UnitID = 0;
                    ...
                    myDoc.SetParameterValue("@TherapyID", TherapyID, "SubEmbryoTransfer.rpt");
                    myDoc.SetParameterValue("@TherapyUnitID", TherapyUnitID, "SubEmbryoTransfer.rpt");
