...
{
    public partial class DonorSampleWF : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("DonorSampleCR.rpt"));
                    long UnitID = 0;
                    ...
                    myDoc.SetParameterValue("@FrmNo", FrmNo, "CrryoDetails");
                    myDoc.SetParameterValue("@UnitID", UnitID, "CrryoDetails");
