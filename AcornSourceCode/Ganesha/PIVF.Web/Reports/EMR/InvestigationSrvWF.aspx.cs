...
{
    public partial class InvestigationSrvWF : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("InvestigationSrvCR.rpt"));
                    long UnitID = 0;
                    long VisitUnitID = 0;
                    long VisitID = 0;
                    long PatientID = 0;
                    ...
                    if (DecodedQuery["Cat"] != null && DecodedQuery["Cat"] != "0")
                    {
                        CategoryID = Convert.ToInt64(DecodedQuery["Cat"]);
                    }
                    myDoc.SetParameterValue("@UnitID", UnitID, "UnitHeader.rpt");  //UnitRpt
