...
{
    public partial class SemenAnalysisWF : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("SemenAnalysisCR.rpt"));
                    long UnitID = 0;
                    ...
                    if (DecodedQuery["SNo"] != null && DecodedQuery["SNo"] != "0")
                    {
                        SNo = DecodedQuery["SNo"];
                    }
                    ...
                    myDoc.SetParameterValue("@SNo", SNo);
