...
namespace PIVF.Web.Reports.EmbryoBank
{
    public partial class EmbryoBankExpiryDetails1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("EmbryoBankExpiryDetails.rpt"));
                    long UnitID = 0;
                    ...
                    myDoc.SetParameterValue("@Action", "GetEmbryBankDetails");
