...
{
    public partial class PatientActivityReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("PatientActivityCR.rpt"));
                    ...
                    myDoc.SetParameterValue("@FToday", FromDate);
                    myDoc.SetParameterValue("@vToday", ToDate);
