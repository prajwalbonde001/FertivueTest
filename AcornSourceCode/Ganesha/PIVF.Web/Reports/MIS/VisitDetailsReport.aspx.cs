...
{
    public partial class VisitDetailsReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("VisitDetailsCR.rpt"));
                    ...
                    if (DecodedQuery["MISDayID"] != null && DecodedQuery["MISDayID"] != "0")
                    {
                        MISDayID = Convert.ToInt64(DecodedQuery["MISDayID"]);
                    }
                    ...
                    myDoc.SetParameterValue("@MISDayID", MISDayID);
