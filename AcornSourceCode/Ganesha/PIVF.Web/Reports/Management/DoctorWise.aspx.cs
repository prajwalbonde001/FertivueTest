...
{
    public partial class DoctorWise1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("DoctorWise.rpt"));
                    string Title = "";
                    long UnitID = 0;
                    if (DecodedQuery["T"] != null && DecodedQuery["T"] != "0")
                    {
                        Title = Convert.ToString(DecodedQuery["T"]);
                    }
                    ...
                    myDoc.SetParameterValue("@Total", "");
                    myDoc.SetParameterValue("@I", -1);
                    myDoc.SetParameterValue("@Name", "");
