...
namespace PIVF.Web.Reports.New_Billing.MIS_Reports.DailyCollection
{
    public partial class DailyCollectionReportWF : System.Web.UI.Page
    {
            ...
            try
            {
                if (Session["Currentuser"] != null)
                {
                    ...
                    myDoc = new ReportDocument();
                     ...
                     myDoc.Load(Server.MapPath("DailyCollection.rpt")); 
                    long UnitID = 0;
                    string pdf = "pdf";
                    ...
                    myDoc.SetParameterValue("@SendClinicID", UnitID);
