...
namespace PIVF.Web.Reports.New_Billing.MIS_Reports.OutstandingReport
{
    public partial class OutstandingReportWF : System.Web.UI.Page
    {
            ...
            try
            {
                if (Session["Currentuser"] != null)
                {
                    ...
                    myDoc = new ReportDocument();
                     ...
                     myDoc.Load(Server.MapPath("OutstandingReport.rpt"));
