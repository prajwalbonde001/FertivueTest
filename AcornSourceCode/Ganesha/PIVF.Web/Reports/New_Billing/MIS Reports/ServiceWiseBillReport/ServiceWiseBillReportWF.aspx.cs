...
namespace PIVF.Web.Reports.New_Billing.MIS_Reports.ServiceWiseBillReport
{
    public partial class ServiceWiseBillReportWF : System.Web.UI.Page
    {
            ...
            try
            {
                if (Session["Currentuser"] != null)
                {
                    ...
                    myDoc = new ReportDocument();
                     ...
                     myDoc.Load(Server.MapPath("ServiceWiseBilling.rpt"));
