...
namespace PIVF.Web.Reports.SpermBank
{
    public partial class SpermBankExpiryDetails1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Session["CurrentUser"] != null)
                {
                    ...
                    myDoc.Load(Server.MapPath("SpermBankExpiryDetails.rpt"));
                    ...
                    myDoc.SetParameterValue("@statusOption", statusOption);
