angular.module('PIVF').controller('day7Ctrl', function ($sce, $scope, RootPGInfo, $uibModalInstance, DaySevenSrv, $filter, $timeout, Common , srvCommon, AlertMessage, $uibModal, PageConfig, localStorageService, usSpinnerService) {
    $scope.CommonFiled = {};
    $scope.CoupleDetails = {};
    ...
    $scope.Unobserved = 0;
    $scope.PGDPGS = 0;
    $scope.disableClickDay6= false;        //Added by Nayan Kamble on 11/06/2019
    /*START : Date */
    ...
    //========================================================================================================================================================================
    //Fill Oocyte Grid
    $scope.GetOocyteForDaySix = function () {
        ...
        var ResponseData = DaySevenSrv.fillDaySixOocyteGrid($scope.CoupleDetails.FemalePatient.FemalePatientID, $scope.CoupleDetails.FemalePatient.FemalePatientUnitID, $scope.CoupleDetails.FemalePatient.TherapyID, $scope.CoupleDetails.FemalePatient.TherapyUnitID);
        ResponseData.then(function (Response) {
            //Fill All Master
            var ResponseData = DaySevenSrv.FillDaySixMaster($scope.CoupleDetails.FemalePatient.FemalePatientID, $scope.CoupleDetails.FemalePatient.FemalePatientUnitID, $scope.CoupleDetails.FemalePatient.TherapyID, $scope.CoupleDetails.FemalePatient.TherapyUnitID);
            ResponseData.then(function (MasterResponse) {
                ...
                if ((item.PGDPGSDate != null && $scope.CoupleDetails.FemalePatient.DonorCycleCode != "") || item.Finalize == true) {
                    item.DisablePGDPGS6 = true;

                }

                if ((item.AssistedHatching == true && $scope.CoupleDetails.FemalePatient.DonorCycleCode != "") || item.Finalize == true) {
                    item.DonorAssistedHatching = true;

                }
                else if (item.AssistedHatching == true && item.Finalize == true) {
                    item.DonorAssistedHatching = true;
        ...
        angular.forEach($filter('filter')($scope.OocyteGrid, function (d) { return d.OocyteNumber !== selectedOocyte; }), function (Oocytes1, index) {
            angular.forEach(ApplayTo, function (selectedocytes) {
                if (selectedocytes.ID == Oocytes1.OocyteNumber) {
                    ...
                    $scope.DayFive = Oocytes1.DayFive;
                    ...
                    Oocytes1.DayFive = $scope.DayFive;
    ...
    $scope.GetImg = {};
    $scope.PreviewImgDay6 = function (Imgcollection) {
        angular.element(myModalDay6).modal('show');
    ...
    $scope.ImgPreviewOk = function () {
        angular.element(myModalDay6).modal('hide');
    }
    ...
    $scope.ClearSaveDays = function ClearSaveDays() {    //Added by Nayan Kamble on 11/06/2019
        $scope.disableClickDay6 = false;
    }

    $scope.SaveDay6Process = function () {
        $scope.disableClickDay6 = true;     //Added by Nayan Kamble on 11/06/2019
        usSpinnerService.spin('GridSpinner');
            ...
            if ($scope.CoupleDetails.FemalePatient.IsDonor) {
                //if ($scope.MasterData.DonarLinkCycleIsAvialble > 0) {
                    ...
                    if ($scope.isvalid == false) {
                        ...
                        var ResponseData = DaySevenSrv.SaveDay6Process($scope.GetActiveOocytes);
                        ResponseData.then(function (Response) {
                            if (Response.data == 1) {
    ...
    //=====Disable Cryo Plan When Extend Culture Start this day===================================================================================================================================================================
    ...
    $scope.ViewReport = function (item) {
        ...
        angular.element(myModalImagePDFDay6).modal('show');
    }
    //========================================================================================================================================================================
