angular.module('PIVF').controller('CryoBankOocyteSubmenuCtr', function ($scope, $rootScope, $filter, CryoPreservationSrv, AlertMessage, srvCommon, Common, srvSemenFreez, PatientInfo, usSpinnerService, OocyteThowSrv) {
    debugger;
