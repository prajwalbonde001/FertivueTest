...
angular.module('PIVF').controller('CryoBankSpermSubmenuCtr', function ($scope, $rootScope, PatientInfo, $location, AlertMessage, swalMessages, Common, CryobankSpermSrv, srvCommon, $filter, srvSemenFreez, SemenPrepService, srvSemenThawing, usSpinnerService) {
