angular.module('PIVF').controller('EmbryoBankCtr', function ($scope, $rootScope, $filter, CryoPreservationSrv, AlertMessage, srvCommon, Common, srvSemenFreez, PatientInfo, usSpinnerService, OocyteThowSrv) {
