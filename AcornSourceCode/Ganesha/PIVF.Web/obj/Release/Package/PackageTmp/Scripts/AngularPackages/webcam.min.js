//"use strict"; !function () { navigator.getMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia; window.hasUserMedia = function () { return navigator.getMedia ? !0 : !1 } }(); angular.module("webcam", []).directive("webcam", function () { return { template: '<div class="webcam" ng-transclude><\/div>', restrict: "E", replace: !0, transclude: !0, scope: { onError: "&", onStream: "&", onStreaming: "&", placeholder: "=", config: "=channel" }, link: function (n, t) { var i = null, u = null, r = null; n.config = n.config || {}; var f = function (n) { n && angular.element(n).remove() }, e = function () { u && "function" == typeof u.stop && u.stop(); i && delete i.src }, h = function (t) { if (u = t, navigator.mozGetUserMedia) i.mozSrcObject = t; else { var r = window.URL || window.webkitURL; i.src = r.createObjectURL(t) } i.play(); n.config.video = i; n.onStream && n.onStream({ stream: t }) }, o = function (t) { f(r); console && console.log && console.log("The following error occured: ", t); n.onError && n.onError({ err: t }) }, s = function () { var c; i = document.createElement("video"); i.setAttribute("class", "webcam-live"); i.setAttribute("autoplay", ""); t.append(i); n.placeholder && (r = document.createElement("img"), r.setAttribute("class", "webcam-loader"), r.src = n.placeholder, t.append(r)); var u = !1, e = t.width = n.config.videoWidth || 270, s = t.height = 0; if (!window.hasUserMedia()) return void o({ code: -1, msg: "Browser does not support getUserMedia." }); c = { video: !0, audio: !1 }; navigator.getMedia(c, h, o); i.addEventListener("canplay", function () { if (!u) { var t = e / i.videoWidth; s = i.videoHeight * t || n.config.videoHeight; i.setAttribute("width", e); i.setAttribute("height", s); u = !0; n.config.video = i; f(r); n.onStreaming && n.onStreaming() } }, !1) }, c = function () { e(); i.remove() }; n.$on("$destroy", e); n.$on("START_WEBCAM", s); n.$on("STOP_WEBCAM", c); s() } } });
...
////Added by Nayan Kamble on 17/10/2019
...
//    window.hasUserMedia = function () { return navigator.getUserMedia ? !0 : !1 }
//}();
angular.module("webcam", []).directive("webcam", function () {
    return {
        template: '<div class="webcam" ng-transclude><\/div>', restrict: "E", replace: !0, transclude: !0, scope: { onError: "&", onStream: "&", onStreaming: "&", placeholder: "=", config: "=channel" }, link: function (n, t) {
            var i = null, u = null, r = null; n.config = n.config || {}; var f = function (n) { n && angular.element(n).remove() }, e = function () { u && "function" == typeof u.stop && u.stop(); i && delete i.src }, h = function (t) {
                if (u = t, navigator.mozGetUserMedia)
                    i.mozSrcObject = t;
                else {
                    var r = window.URL || window.webkitURL;
                    //var binaryData = [];
                    //binaryData.push(t);
                    //i.src = r.createObjectURL(new Blob(binaryData, {
                    //    type: "appliation/zip"
                    //}))
                    console.log(t);
                ...
                n.config.video = i; n.onStream && n.onStream({ stream: t })
            }, o = function (t) { f(r); console && console.log && console.log("The following error occured: ", t); n.onError && n.onError({ err: t }) }, s = function () { var c; i = document.createElement("video"); i.setAttribute("class", "webcam-live"); i.setAttribute("autoplay", ""); t.append(i); n.placeholder && (r = document.createElement("img"), r.setAttribute("class", "webcam-loader"), r.src = n.placeholder, t.append(r)); var u = !1, e = t.width = n.config.videoWidth || 270, s = t.height = 0; if (!window.hasUserMedia()) return void o({ code: -1, msg: "Browser does not support getUserMedia." }); c = { video: !0, audio: !1 }; navigator.getUserMedia(c, h, o); i.addEventListener("canplay", function () { if (!u) { var t = e / i.videoWidth; s = i.videoHeight * t || n.config.videoHeight; i.setAttribute("width", e); i.setAttribute("height", s); u = !0; n.config.video = i; f(r); n.onStreaming && n.onStreaming() } }, !1) }, c = function () { e(); i.remove() }; n.$on("$destroy", e); n.$on("START_WEBCAM", s); n.$on("STOP_WEBCAM", c); s()
        }
    }
});
