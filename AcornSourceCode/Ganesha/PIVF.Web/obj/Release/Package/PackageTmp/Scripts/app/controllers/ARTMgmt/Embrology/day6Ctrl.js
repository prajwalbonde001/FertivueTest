angular.module('PIVF').controller('day6Ctrl', function ($sce, $scope, RootPGInfo, $uibModalInstance, DaySixSrv, $filter, $timeout, Common, srvCommon, AlertMessage, $uibModal, PageConfig, localStorageService, usSpinnerService) {
    $scope.CommonFiled = {};
    $scope.CoupleDetails = {};
    ...
    $scope.GetOocyteForDaySix = function () {
        ...
        var ResponseData = DaySixSrv.fillDaySixOocyteGrid($scope.CoupleDetails.FemalePatient.FemalePatientID, $scope.CoupleDetails.FemalePatient.FemalePatientUnitID, $scope.CoupleDetails.FemalePatient.TherapyID, $scope.CoupleDetails.FemalePatient.TherapyUnitID);
        ResponseData.then(function (Response) {
            //Fill All Master
            var ResponseData = DaySixSrv.FillDaySixMaster($scope.CoupleDetails.FemalePatient.FemalePatientID, $scope.CoupleDetails.FemalePatient.FemalePatientUnitID, $scope.CoupleDetails.FemalePatient.TherapyID, $scope.CoupleDetails.FemalePatient.TherapyUnitID);
        ...
        if ($scope.isvalidTopVlaidation == false) {
            if ($scope.CoupleDetails.FemalePatient.IsDonor) {
                ...
                if ($scope.isvalid == false) {
                    ...
                    var ResponseData = DaySixSrv.SaveDay6Process($scope.GetActiveOocytes);
                    ResponseData.then(function (Response) {
                        if (Response.data == 1) {
