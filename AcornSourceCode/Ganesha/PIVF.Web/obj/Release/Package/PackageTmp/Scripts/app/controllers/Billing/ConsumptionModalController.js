'use strict';
angular.module('PIVF').controller('ConsumptionModalController', function ($scope, $uibModalInstance,$location, selectedBill, BillingService,srvCommon, $http,AlertMessage,Common,PatientAdvanceRefundSrv,ConsumptionService) {
debugger
...
$scope.PaymentDetails = {
    ...
    $scope.GetMaterialConsumptionItemList()
 ...
 $scope.popup1 = {
    ...
    // Date pickr End
    $scope.GetMaterialConsumptionItemList = function GetMaterialConsumptionItemList() {
       debugger;        
        $scope.GetMaterialConsumptionItemList = [];        
        var Promise = ConsumptionService.GetMaterialConsumptionItemList($scope.selectedBill.MaterialConsumptionID,$scope.selectedBill.MaterialConsumptionUnitID);
        Promise.then(function (Promise) {
        debugger
            $scope.GetMaterialConsumptionItemList = Promise.data;
        }, function (error) {
    ...
    $scope.GetPatientDetails = function GetPatientDetails() {
       debugger;        
        $scope.PatientList = [];        
        var Promise = ConsumptionService.GetMaterialConsumptionItemList($scope.selectedBill.BillID);
        Promise.then(function (Promise) {
        debugger
