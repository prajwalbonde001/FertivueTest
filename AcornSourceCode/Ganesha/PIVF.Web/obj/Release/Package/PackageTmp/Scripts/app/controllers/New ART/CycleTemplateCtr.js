...
'use strict';
angular.module('PIVF').controller('EMRTemplateCtr', function ($rootScope, $scope, EMRTemplateSrv, DesignEMRSrv , $location, Common, $uibModal,$uibModalInstance, AlertMessage, usSpinnerService) {
    ...
    $scope.SaveUpdateCycleTemplate = function () {
