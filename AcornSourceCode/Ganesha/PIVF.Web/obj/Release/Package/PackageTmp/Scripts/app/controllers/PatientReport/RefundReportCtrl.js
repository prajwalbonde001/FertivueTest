...
angular.module('PIVF').controller('RefundReportCtrl', function ($scope, AlertMessage , srvCommon , Common, $rootScope, localStorageService , PatientReportsService , usSpinnerService ) {
...
$scope.GetReportData = function (UnitID , FromDate , ToDate){
    var response = PatientReportsService.GetRefundReportReciept(UnitID , FromDate , ToDate);
...
$scope.downloadReportNewWithPreview = function () {
    ...
    const dynamicFilename = `Refund_Report.pdf`;
